...
//go:generate go run -tags=tools ../cmd/build/build.go fetch https://github.com/openhue/openhue-api/releases/download/1.1/openhue.yaml openhue.gen.yaml
//go:generate go run -tags=tools github.com/oapi-codegen/oapi-codegen/v2/cmd/oapi-codegen --config=oapi-codegen-openhue.yaml openhue.gen.yaml
//go:generate go run -tags=tools ../cmd/build/build.go generate api.gen.go ../hue.gen.go
